...
const imagee = document.querySelector('#bg')
let date = new Date();
...
form.addEventListener('submit', function (e) {
    ...
    fetch(url).then((response) => {
        ...
        if (weatherMain == 'Clear') {
            image.src = `assets/Images/sunnyw.png`
            myWeatherContainer.style.backgroundColor = '#ec6e4c'
            me.innerHTML = "Testing" ;
        ...
        if (weatherMain == 'Drizzle') {
            image.src = `assets/Images/drizzle.png`
        ...
        if (currentMonth == 'Jun') {
            imagee.src = `assets/Images/drizzle.png`
        }
